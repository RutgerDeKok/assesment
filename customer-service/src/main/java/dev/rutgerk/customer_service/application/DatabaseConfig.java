...
@EnableJpaRepositories(basePackages = "dev.rutgerk.customer_service.repository",
...
public class DatabaseConfig {
  ...
  public LocalContainerEntityManagerFactoryBean entityManager() {
    ...
    entityManagerFactory.setPackagesToScan(new String[] {"dev.rutgerk.customer_service.model"});
